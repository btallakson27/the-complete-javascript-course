...
// and append it to an existing <ul> (unordered list) with the ID list-container.
//**CLUE** IF YOU'RE MAKING A NEW LIST, YOU NEED TO PUT IT IN THE DOCUMENT!!!
// MASTERED
...
// that if the class is present it gets removed, and if it's not, it gets added?
// MASTERED
...
// 10. Manipulating Attributes and Properties: Write JavaScript code to change the src attribute of an <img> element 
// and explain the difference between attributes and properties in the context of DOM elements.
// 99% MASTERED 



// 11. Utilizing Dataset Attributes: Explain how to use data attributes within an HTML element to store extra information 
// and how to access this information using JavaScript. Won't encounter much.,
// 90% MASTERY 
